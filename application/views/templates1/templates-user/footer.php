        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        <li><i class="bx bx-chevron-right text-white"></i> <a class="text-white" href="#">Sistem Informasi</a></li>
                        <li><i class="bx bx-chevron-right text-white"></i> <a class="text-white" href="#">Sistem Informasi Akuntansi</a></li>
                        <li><i class="bx bx-chevron-right text-white"></i> <a class="text-white" href="#">Teknik Komputer</a></li>
                    </ul>
                </div>

            ...
            <section id="about" class="about section-bg bg-white" style="background-image: url('http://localhost/pustaka-booking/assets1/img/3.png');">
                <div class="container" data-aos="fade-up">
                    <div class="section-title">
                        <h2>FAKULTAS</h2>
                        <h3><span class="text-dark">FAKULTAS TEKNIK DAN INFORMATIKA</span></h3>
                        <p class="text-dark"><i class='bx bxs-building-house'></i>Universitas Bina Sarana Informatika Kampus Tegal</p>
                    </div>
                    <div class="row">

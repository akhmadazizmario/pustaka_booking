            ...
            <section id="about" class="about section-bg bg-white" style="background-image: url('<?php echo base_url() ?>assets1/img/3.png');">
                <div class="container" data-aos="fade-up">
                    <div class="section-title">
                        ...
                        <h3><span class="text-dark">Perpustakaan Universitas Bina Sarana Informatika Kampus Tegal</span></h3>
                    </div>
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="resume-item pb-0">
                                        ...
                                        <p>sebelum meminjam , status mahasiswa harus aktif yah .</p><br>
                                    </div>
                                    <div class="resume-item pb-0">
                                        <h4>Bisa untuk mahasiswa semester 1-6</h4>
                                        <p>seluruh mahasiswa aktif semester 1-6 boleh meminjam </p><br>
                                    </div>
                                    <div class="resume-item pb-0">
                                        <h4>Tidak memiliki kasus buku rusak/hilang sampai 3x</h4>
                                        <p>Apabila mahasiswa memiliki kasus buku rusak/hilang 3x tidak diperbolehkan untuk meminjam</p><br>
                                    </div>
                                </div>
                            </div>
